...
module.exports = class HCaptchaTaskProxyless extends CapmonsterClient {
    constructor(clientKey) {
        super(clientKey);
    }
    async createTask(website_url,
                     website_key,
                     user_agent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.132 Safari/537.36") {
        const data = {
